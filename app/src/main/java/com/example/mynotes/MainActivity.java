...
public class MainActivity extends AppCompatActivity implements NotesFragment.OnNoteListInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!displayingEditor) {
            ...
            ft.add(R.id.container, NotesFragment.newInstance(notes));
            ft.commit();
